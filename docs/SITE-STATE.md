...
- `More` menu contains `Join Sales Team`, `About`, `Contact`, `FAQ`.
- Mobile menu mirrors this ordering; `Get Started` button links to `package-builder.html`.

### Services Page
- All “Get Started” buttons route to `package-builder.html`.
- Gideon builder vs selector CTA lives directly above the footer.
- Add-on section lists Gideon AI (Basic/Pro), Social Media, Google Ads, SEO Starter/Growth with “Configure in Builder” CTAs.
...
- Three-option section (Contact, Builder, AI Wizard) remains unchanged below.
